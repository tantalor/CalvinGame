levels=[
	{levelText:"TUTORIAL 1. Move to the goal. No jumping. The faster you complete the level, the more points you get!",
		...
		portals:[{color:"red",x:[160,130],y:[315,135],theta:[0,0],loc:[1,-1]},
			...
			{color:"cyan",x:[266,290],y:[235,135],theta:[0,0],loc:[-1,-1]}],
		score:7},
		...
		floor:[{x:30,y:10,width:260,theta:0,type:"floor"},
			...
			{x:30,y:305,width:240,theta:0,type:"floor"},
			{x:270,y:305,width:30,theta:0,type:"flip"},
			{x:300,y:305,width:150,theta:0,type:"floor"},
			{x:30,y:380,width:300,theta:0,type:"floor"},
			{x:330,y:380,width:30,theta:0,type:"flip"},
			{x:360,y:380,width:90,theta:0,type:"floor"},
			{x:30,y:10,width:371,theta:Math.PI/2,type:"wall"},
			{x:450,y:10,width:371,theta:Math.PI/2,type:"wall"},
			...
			{x:230,y:305,width:50,theta:Math.PI/8,type:"floor"}
			],
		x:40,
		y:125,
		flagX:420,
		...
		portals:[{color:"red",x:[200,200],y:[30,160],theta:[0,0],loc:[-1,-1]},
			...
			{color:"yellow",x:[260,120],y:[30,325],theta:[0,0],loc:[-1,-1]}],
		score:23},
			
		{levelText:"HOUSE",
		floor:[{x:20,y:410,width:440,theta:0,type:"floor"},
			{x:80,y:178,width:230,theta:Math.PI/2,type:"wall"},
			{x:400,y:186,width:225,theta:Math.PI/2,type:"wall"},
			{x:79,y:180,width:186,theta:-Math.PI/6,type:"floor"},
			{x:240,y:87,width:146,theta:Math.PI/6,type:"floor"},
			{x:80,y:255,width:109,theta:Math.PI/4,type:"floor"},
			{x:155,y:330,width:100,theta:0,type:"floor"},
			{x:253,y:329,width:115,theta:Math.PI/4,type:"floor"},
			{x:80,y:256,width:40,theta:0,type:"bridge"},
			{x:119,y:256,width:40,theta:0,type:"floor"},
			{x:159,y:256,width:40,theta:0,type:"flip"},
			{x:199,y:256,width:61,theta:0,type:"floor"},
			{x:260,y:256,width:160,theta:-Math.atan(76/140),type:"floor"},
			{x:360,y:180,width:40,theta:0,type:"bridge"},
			{x:250,y:180,width:110,theta:0,type:"floor"},
			{x:210,y:180,width:40,theta:0,type:"flip"},
			{x:80,y:180,width:130,theta:0,type:"floor"},
			{x:400,y:180,width:26,theta:0,type:"floor"},
			{x:424,y:181,width:25,theta:-Math.PI/4,type:"floor"},
			{x:330,y:143,width:37,theta:Math.PI/2,type:"wall"},
			{x:220,y:100,width:40,theta:0,type:"floor"}],
		x:380,
		y:405,
		flagX:240,
		flagY:100,
		flagTheta:Math.PI,
		portals:[{color:"green",x:[150,405],y:[180,180],theta:[0,0],loc:[1,1]},
			{color:"pink",x:[50,430],y:[410,410],theta:[0,0],loc:[1,1]}],
		score:12},
	...
	floor:[{x:50,y:50,width:151,theta:Math.PI/2,type:"wall"},
		...
		{x:150,y:250,width:150,theta:Math.PI/2,type:"wall"},
		...
		{x:150,y:301,width:20,theta:0,type:"flip"},
		{x:170,y:301,width:20,theta:0,type:"floor"},
		{x:189,y:300,width:Math.sqrt(2)*41,theta:Math.PI/4,type:"floor"},
		{x:229,y:339,width:30,theta:0,type:"floor"},
		{x:258,y:340,width:Math.sqrt(2)*20,theta:-Math.PI/4,type:"floor"},
		{x:278,y:321,width:180,theta:0,type:"floor"},
		{x:458,y:315,width:85,theta:Math.PI/2,type:"wall"},
		{x:150,y:400,width:75,theta:0,type:"floor"},
		{x:275,y:400,width:183,theta:0,type:"floor"},
		{x:460,y:400,width:20,theta:0,type:"flip"},
		{x:350,y:425,width:150,theta:0,type:"floor"},
		{x:320,y:425,width:30,theta:0,type:"flip"},
		{x:250,y:425,width:70,theta:0,type:"floor"},
		{x:223,y:401,width:Math.sqrt(2)*21,theta:-Math.PI/4,type:"floor"},
		{x:244,y:381,width:31,theta:0,type:"floor"},
		{x:275,y:381,width:19,theta:Math.PI/2,type:"wall"}],
	x:140,
	y:248,
	flagX:450,
	flagY:425,
	...
	portals:[{color:"red",x:[60,60],y:[154,70],theta:[0,0],loc:[1,-1]},
		...
		{color:"lime",x:[255,290],y:[401,400],theta:[0,0],loc:[-1,1]},
		{color:"lime",x:[320,425],y:[400,70],theta:[0,0],loc:[1,-1]},
		{color:"lime",x:[350,185],y:[400,120],theta:[0,0],loc:[1,-1]},
