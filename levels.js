var levels = [
  ...
  { levelText: "IT'S A TRAP(EZOID)!",
    ...
    portals: [{color: "#fff94c", a:{x: 295, y: 120, theta: 0, loc: 1}, b: {x: 295, y: 140, theta: 0, loc: -1}},
      {color: "#6f0ca0", a:{x: 275, y: 140, theta: 0, loc: -1}, b: {x: 435, y: 170, theta: 0, loc: -1}},
      {color: "#ea20d9", a:{x: 175, y: 120, theta: 0, loc: 1}, b: {x: 415, y: 150, theta: 0, loc: 1}},
      {color: "#ff7b07", a:{x: 175, y: 140, theta: 0, loc: -1}, b: {x: 35, y: 360, theta: 0, loc: 1}},
      {color: "#1accf4", a:{x: 315, y: 140, theta: 0, loc: -1}, b: {x: 255, y: 180, theta: 0, loc: 1}},
      {color: "#c6b995", a:{x: 335, y: 140, theta: 0, loc: -1}, b: {x: 175, y: 260, theta: 0, loc: -1}},
      {color: "#2db524", a:{x: 355, y: 140, theta: 0, loc: -1}, b: {x: 495, y: 330, theta: 0, loc: 1}},
      {color: "#edaf12", a:{x: 235, y: 170, theta: 0, loc: -1}, b: {x: 435, y: 270, theta: 0, loc: 1}},
      {color: "#999999", a:{x: 315, y: 170, theta: 0, loc: -1}, b: {x: 255, y: 360, theta: 0, loc: 1}},
      {color: "#77bad1", a:{x: 355, y: 185, theta: 0, loc: -1}, b: {x: 235, y: 300, theta: 0, loc: 1}},
      {color: "#d17b9c", a:{x: 395, y: 200, theta: 0, loc: -1}, b: {x: 235, y: 240, theta: 0, loc: 1}},
      {color: "#b9cae5", a:{x: 135, y: 210, theta: 0, loc: 1}, b: {x: 58, y: 360, theta: 0, loc: 1}},
      {color: "#114f1b", a:{x: 135, y: 230, theta: 0, loc: -1}, b: {x: 475, y: 270, theta: 0, loc: 1}},
      {color: "#8c750e", a:{x: 135, y: 260, theta: 0, loc: -1}, b: {x: 395, y: 170, theta: 0, loc: -1}},
      {color: "#513306", a:{x: 215, y: 360, theta: 0, loc: 1}, b: {x: 435, y: 200, theta: 0, loc: -1}},
      {color: "#e3f4b5", a:{x: 75, y: 360, theta: 0, loc: 1}, b: {x: 495, y: 300, theta: 0, loc: 1}},
      {color: "#4277af", a:{x: 155, y: 340, theta: 0, loc: -1}, b: {x: 395, y: 300, theta: 0, loc: 1}},
      {color: "#44fffb", a:{x: 415, y: 270, theta: 0, loc: 1}, b: {x: 415, y: 230, theta: 0, loc: -1}},
      {color: "#82cc5f", a:{x: 175, y: 340, theta: 0, loc: -1}, b: {x: 375, y: 230, theta: 0, loc: -1}},
      {color: "#ed1010", a:{x: 275, y: 360, theta: 0, loc: 1}, b: {x: 515, y: 290, theta: 0, loc: -1}},
      {color: "#f78cf3", a:{x: 135, y: 360, theta: 0, loc: 1}, b: {x: 455, y: 230, theta: 0, loc: -1}}
    ],
    startx: 300,
    starty: 113},
	...
	floor:[{left:{x:100,y:400},right:{x:380,y:400},type:"floor"},
		...
		{left:{x:190,y:207},right:{x:230,y:207},type:"floor"},
	...
	portals:[{color:"orange", a:{x:252,y:160,theta:0,loc:1},b:{x:305,y:100,theta:0,loc:1}},
		...
		{color:"green",a:{x:270,y:245,theta:0,loc:1},b:{x:212,y:227,theta:0,loc:-1}},
		...
		{color:"magenta",a:{x:462,y:245,theta:0,loc:-1},b:{x:198,y:227,theta:0,loc:-1}}],
	startx:490,
	starty:398},
