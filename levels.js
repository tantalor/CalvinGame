levels=[
	{levelText:"TUTORIAL 1. Move to the goal. No jumping. The faster you complete the level, the more points you get!",
		...
		floor:[{x:30,y:10,width:260,theta:0,type:"floor"},
			...
			{x:30,y:420,width:300,theta:0,type:"floor"},
			{x:330,y:420,width:30,theta:0,type:"flip"},
			{x:360,y:420,width:90,theta:0,type:"floor"},
			{x:30,y:10,width:410,theta:Math.PI/2,type:"wall"},
			{x:450,y:10,width:410,theta:Math.PI/2,type:"wall"},
